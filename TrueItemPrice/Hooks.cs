...
public class Hooks : IDisposable {
    ...
    public unsafe Hooks(TrueItemPricePlugin plugin) {
        ...
        Service.AddonLifecycle.RegisterListener(AddonEvent.PreRequestedUpdate, "ItemDetail", (_, args) => ItemTooltip.RestoreToNormal((AtkUnitBase*)args.Addon));
        Service.AddonLifecycle.RegisterListener(AddonEvent.PostRequestedUpdate, "ItemDetail", (_, args) => plugin.ItemTooltip.OnItemTooltip((AtkUnitBase*)args.Addon));
    }
